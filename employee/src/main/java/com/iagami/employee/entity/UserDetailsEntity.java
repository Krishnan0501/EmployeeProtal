...
public class UserDetailsEntity {
	...
	public void setEntity_Id(Integer integer) {
		this.entity_Id = integer;
	}
    ...
    public UserDetailsEntity(String password, String emailId, LocalDateTime changedPasswordDate, 
